...
(define-struct assign-func (var func-def))
(define-struct assign-call (var func-call))
(define-struct func-def (vars cmd))
(define-struct func-call (var args))
(define-struct single-var (var))
(define-struct multi-var (var vars))
(define-struct single-arg (arg))
(define-struct multi-arg (arg args))
